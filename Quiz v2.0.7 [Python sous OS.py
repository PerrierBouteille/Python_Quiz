...
def quiz():
    ...
    for i in range(reader.line_num):
        ...
        def subit():
            ...
            print(colors.WARNING + "[Logs] Réponse ASCII :" + colors.END + "" + str(finalans))
            print(colors.WARNING + "[Logs] Réponse LOWER :" + colors.END + "" + str(finalans.lower())) #Écriture de la réponse en minuscule
            if str(finalans.lower()) == CorrectAnswer:
